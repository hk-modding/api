...
namespace Modding.Patches
{
    ...
    public class StartManager : global::StartManager
    {
        ...
        private IEnumerator Start()
        {
            ...
            {
                // Wait for mod loading to finish before transitioning
                while ((ModLoader.LoadState & ModLoader.ModLoadState.Loaded) == 0)
                {
                    yield return null;
                }
                yield return UnityEngine.SceneManagement.SceneManager.LoadSceneAsync("Menu_Title");
            }
            yield break;
        }
    }
